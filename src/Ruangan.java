...
public class Ruangan {
    ...
    private HealingItem objpot,objpot2;
    ...
    public Ruangan() {
        ...
        // tambahan Healing Item
        objpot  = new HealingItem("HP potion S");
        objpot.setDeskripsi("Potion untuk menambah HP anda sebesar 20");
        objpot.setEfek(20);
        objpot.setAmount(1);
        objpot.setObjRuangan(this);

        objpot2  = new HealingItem("HP potion L");
        objpot2.setDeskripsi("Potion untuk menambah HP anda sebesar 100");
        objpot2.setEfek(100);
        objpot2.setAmount(1);
        objpot2.setObjRuangan(this);
